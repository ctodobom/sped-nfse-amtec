...
namespace NFePHP\NFSeAmtec\Common\Soap;
...
use NFePHP\NFSeAmtec\Common\Soap\SoapBase;
...
class SoapCurl extends SoapBase implements SoapInterface
{
    ...
    public function send(
        ...
        try {
            ...
            $tz = time();
            //file_put_contents(
            //"/var/www/sped/sped-nfse-amtec/local/fixtures/req_{$operation}_{$tz}.xml",
            // $envelope
            // );
        ...
        //file_put_contents(
        //"/var/www/sped/sped-nfse-amtec/local/fixtures/res_{$operation}_{$tz}.xml",
        // $this->responseBody
        // );
